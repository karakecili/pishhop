...
<!-- Note: You should change error path inside of ./.nuxt/components/nuxt.js in order to create custom error page -->
<!-- Note2: This template is copied from https://tailwindcomponents.com/component/404-not-found-page -->
